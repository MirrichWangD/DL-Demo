...
// Settings
const IMAGE_WIDTH = 32; // 图片宽度
const IMAGE_HEIGHT = 32; // 图片长度
const IMAGE_CHANNELS = 3;  // 图片通道数
const NUM_CLASSES = 10;  // 数据集类别数

const EPOCHS = 10; // 训练周期
const BATCH_SIZE = 512;  // 批大小

const classNames = ['airplane', 'automobile', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck'];  // CIFAR10
// const classNames = ['Zero', 'One', 'Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight', 'Nine'];  // Mnist

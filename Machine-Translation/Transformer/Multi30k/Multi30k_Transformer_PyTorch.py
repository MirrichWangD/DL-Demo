...
"""
+++++++++++++++++++++++++++++++++++
@ File        : Multi30k_Transformer_PyTorch.py
@ Time        : 2023/4/25 13:24
@ Author      : Mirrich Wang
@ Version     : Python 3.8.12 (Conda)
+++++++++++++++++++++++++++++++++++
原项目链接：https://pytorch.org/tutorials/beginner/translation_transformer.html#data-sourcing-and-processing
+++++++++++++++++++++++++++++++++++
"""
...
for ln in [SRC_LANGUAGE, TGT_LANGUAGE]:
    ...
    train_iter = Multi30k(root="../data/Multi30k", split='train', language_pair=(SRC_LANGUAGE, TGT_LANGUAGE))
...
def train_epoch(model, optimizer):
    ...
    train_dataloader = DataLoader(train_iter, batch_size=BATCH_SIZE, collate_fn=collate_fn, num_workers=0)

...
"""+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
@ 参考链接：
https://blog.csdn.net/hnlg311709000526/article/details/119757376
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"""
...
#嵌入层 (字典vocab_size=4000，另外将每一个数字映射到32维的向量空间中去)
...
with open("19DL/IMDB/Keras_IMDB_RNN_model.json", "w") as json_file:
    json_file.write(model_json)

model.save_weights("19DL/IMDB/Keras_IMDB_RNN_model.h5")

...
model.add(tf.keras.layers.Conv2D(filters=64, kernel_size=(3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.0005),
                                 activation='relu', padding='same'))
model.add(tf.keras.layers.BatchNormalization())
model.add(tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2))

# 卷积层2与池化层2
model.add(tf.keras.layers.Conv2D(filters=128, kernel_size=(3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.0005),
                                 activation='relu', padding='same'))
model.add(tf.keras.layers.BatchNormalization())
...
# 卷积层3与池化层3
model.add(tf.keras.layers.Conv2D(filters=256, kernel_size=(3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.0005),
                                 activation='relu', padding='same'))
model.add(tf.keras.layers.BatchNormalization())
model.add(tf.keras.layers.Dropout(0.4))
model.add(tf.keras.layers.Conv2D(filters=256, kernel_size=(3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.0005),
...
# 卷积层4与池化层4
model.add(tf.keras.layers.Conv2D(filters=512, kernel_size=(3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.0005),
                                 activation='relu', padding='same'))
model.add(tf.keras.layers.BatchNormalization())
model.add(tf.keras.layers.Dropout(0.4))
model.add(tf.keras.layers.Conv2D(filters=512, kernel_size=(3, 3), kernel_regularizer=tf.keras.regularizers.l2(0.0005),

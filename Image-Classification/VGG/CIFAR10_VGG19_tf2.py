...
#输出模型列表，需要调整3000万的参数，Total params: 38,947,914
print(model.summary())



""""@@@ 训练模型 """
epochs=1   #时间：3分钟  训练集准确率：9.95%   测试集准确率：9.80%
...
t2=time.time()
CNNVGG19 = float(t2-t1)
print("Time taken: {} seconds".format(CNNVGG19))
...
open('18DL/SaveModel/VGG19_architecture.json', 'w').write(model_json)
model.save_weights('18DL/SaveModel/VGG19_weights.h5', overwrite=True)

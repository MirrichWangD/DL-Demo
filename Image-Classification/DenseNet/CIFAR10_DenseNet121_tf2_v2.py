...
#输出模型列表，需要调整700万的参数，Total params: 7,057,994
print(model.summary())



""""@@@ 训练模型 """
epochs=1   #时间：1分钟  训练集准确率：38.53%   测试集准确率：22.77%
...
open('18DL/SaveModel/DenseNet121_architecture.json', 'w').write(model_json)
model.save_weights('18DL/SaveModel/DenseNet121_weights.h5', overwrite=True)

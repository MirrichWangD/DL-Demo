...
# 输出模型列表，需要调整400万的参数，Total params: 4,590,986
print(model.summary())

""""@@@ 训练模型 """
epochs = 10  # 时间：1分钟  训练集准确率：35.20%   测试集准确率：21.08%
...
open('./out/Cifar10/DenseNet121_architecture.json', 'w').write(model_json)
model.save_weights('./out/Cifar10/DenseNet121_weights.h5', overwrite=True)

...
""""@@@ 训练模型 """
epochs = 1  # 时间：1分钟  训练集准确率：40.99%   测试集准确率：20.19%
epochs = 50  # 间：8.25分钟  训练集准确率：99.32%   测试集准确率：69.73%
...
t2 = time.time()
CNNResNet18 = float(t2 - t1)
print("Time taken: {} seconds".format(CNNResNet18))
...
open('./out/Cifar10/ResNet18_architecture.json', 'w').write(model_json)
model.save_weights('./out/Cifar10/ResNet18_weights.h5', overwrite=True)

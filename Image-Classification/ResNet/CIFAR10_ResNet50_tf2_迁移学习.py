...
model.add(tf.keras.applications.ResNet50(input_shape=(32, 32, 3), include_top=False, weights="imagenet"))
...
""""@@@ 训练模型 """
epochs = 10  # 时间：5分钟  训练集准确率：77.70%   测试集准确率：72.94%
...
open("18DL/SaveModel/ResNet50_tl_architecture.json", "w").write(model_json)
model.save_weights("18DL/SaveModel/ResNet50_tl_weights.h5", overwrite=True)

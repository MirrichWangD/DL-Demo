...
#输出模型列表，需要调整2000万的参数，Total params: 23,608,202
print(model.summary())



""""@@@ 训练模型 """
epochs=1   #时间：1分钟  训练集准确率：38.25%   测试集准确率：25.86%
...
open('18DL/SaveModel/ResNet50_architecture.json', 'w').write(model_json)
model.save_weights('18DL/SaveModel/ResNet50_weights.h5', overwrite=True)

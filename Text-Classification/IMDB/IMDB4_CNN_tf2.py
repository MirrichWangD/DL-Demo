...
t2 = time.time()
CNNIMDB = float(t2 - t1)
print("Time taken: {} seconds".format(CNNIMDB))
...
# # 评估模型的准确率
#  epochs=10：  CPU：438秒  87.58%    GPU 29秒  87.74%
#  epochs=30：  GPU 87秒  86.23%
# 200/200 - 44s - loss: 0.0672 - accuracy: 0.9772 - 
# val_loss: 0.4999 - val_accuracy: 0.8620
...
# # 保存模型及权重 serialize model to JSON 和 h5
model_json = model.to_json()
with open("./out/IMDB/IMDB_CNN_model.json", "w") as json_file:
    json_file.write(model_json)

model.save_weights("./out/IMDB/IMDB_CNN_model.h5")
